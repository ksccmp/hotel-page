...
export default {
    ...
    data() {
        return {
            reservation: {
                ...
                enddate: this.form == '대실' ? this.$store.state.dates[0] : this.$store.state.dates[1],
                way: false,
            },
    ...
    methods: {
        calc() {
            ...
            this.reservation.person = Number(this.room.standard) + Number(this.addperson);
        ...
        roomSelectById() {
            axios
                ...
                .then(res => {
                    ...
                    this.price = this.form == '대실' ? this.room.rentprice : this.room.fullprice;
                    this.addprice = this.form == '대실' ? this.room.rentaddprice : this.room.fulladdprice;
                })
                .catch(e => {
                    console.log(e);
                });
            ...
            axios
                ...
                .then(res => {
                    if (res.data.data != null) {
                        axios
                            .post('http://localhost:8080/reservationInsert', this.reservation)
                            .then(res => {
                                if (res.data.data == 1) {
                                    console.log('예약완료');
                                    this.$router.push({
